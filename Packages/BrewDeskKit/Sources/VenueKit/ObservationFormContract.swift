...
// Structured community observations (brewdesk#47). The review form IS an
// observation: four enum-valued answers, no free text anywhere — the engine's
...
/// All four answers — every field required, by construction. There is no
/// free-text member and never should be: structure is what makes community
/// input scoreable (epic brewdesk#25).
